...
def compliance_patch_job():
    """Legacy entry point retained as a non-mutating safety tripwire."""
    logger.warning(
        "[compliance_patch_job] Disabled: V2 requires evidence, catalog audit, "
        "and explicit reviewed remediation before Shopify writes."
    )
